    ...
    return(
        <>
         <Col lg="3" md="4" sm="6" xs="6">
              <Card id={"subcard-" + id} className="card-stats mb-4 mb-xl-0 shadow" style={{cursor:"pointer", borderRadius:"0px"}} onClick={()=>props.history.push("/client/upload-file",
                  ...
                  media_type_id:props.location.state.id
                  }
                  )}>
